// 迁移自 DeerFlow frontend/src/components/ai-elements/streamdown.tsx；许可见 src/markdown/DEERFLOW-LICENSE。
"use client";

import { Component, type ComponentProps, type ReactNode } from "react";
import { Streamdown } from "streamdown";

import { stripLeakedSystemTags } from "../../markdown/preprocess";
import { installClipboardFallback } from "../../markdown/clipboard";
...
> {
  ...
  render() {
    if (this.state.errored) {
      return (
        <div className="message-content markdown-fallback break-words whitespace-pre-wrap">
