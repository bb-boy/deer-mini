// 迁移自 DeerFlow，许可见本目录 DEERFLOW-LICENSE；仅作用于显示副本，保存和复制仍使用原文。
const INTERNAL_MARKER_TAGS = ["current_uploads", "uploaded_files", "slash_skill_activation", "system-reminder", "memory", "current_date"] as const;
