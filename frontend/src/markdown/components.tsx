// 迁移自 DeerFlow frontend/src/core/streamdown/components.tsx；许可见 src/markdown/DEERFLOW-LICENSE。
"use client";

import type { ComponentType, JSX } from "react";
import type { Components, ExtraProps } from "streamdown";
import { ReasoningContent, type ReasoningContentProps } from "../components/ai-elements/reasoning";
...
export function SafeReasoningContent({ children, ...props }: ReasoningContentProps) {
