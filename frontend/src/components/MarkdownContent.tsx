// 迁移自 DeerFlow frontend/src/components/workspace/messages/markdown-content.tsx；许可见 src/markdown/DEERFLOW-LICENSE。
"use client";
...
import { type ClipboardSafeStreamdownProps } from "./ai-elements/streamdown";
import {
...
import { streamdownTranslations } from "../markdown/translations";

import { createMarkdownLinkComponent } from "./MarkdownLink";
